...
function add_search_box_to_menu( $form="", $inline=false ) {

	$append = ($inline == false) ? "navbar-form navbar-right" : "form";
	$form .= '<form class="' . $append . '" action="' . home_url( '/' ) . '" method="get" role="search">
				<div class="visible-xs visible-sm"><br /></div>
		        <div class="form-group">
					<input type="text" class="form-control" name="s" placeholder="Search" value="' . @$_REQUEST['s'] . '">
		        </div>
		        <button type="submit" class="btn btn-default visible-xs visible-sm">Search ' . icon("search") . '</button>
		        <button type="submit" class="btn btn-default hidden-xs hidden-sm">' . icon("search") . '</button>
		    </form>';
    return $form;
}
...
function printr($var)
{
    ...
    echo "<div style='font-family:courier;'>$output</div>" . PHP_EOL;
}