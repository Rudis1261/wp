...
function twentyfourteen_posted_on() {
	...
	$output = sprintf( '<span class="entry-date"><strong>Posted</strong> <a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s">%3$s</time></a></span>, <span class="byline"><span class="author vcard"><strong>Author</strong> <a class="url fn n" href="%4$s" rel="author">%5$s</a></span></span>',
